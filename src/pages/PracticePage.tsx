  ...
  return (
    <>
      <section ref={heroRef} className="relative overflow-hidden bg-paper px-0 pb-[clamp(40px,5vw,72px)] pt-[clamp(56px,8vw,104px)] text-ink lg:pt-[34vh]">
        <div className="container-x relative grid gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-start lg:gap-20">
          <div data-reveal="true" className="max-w-none lg:pr-8">
            <h1
          ...
          <div data-reveal="true" style={{ transitionDelay: "90ms" }} className="grid gap-8 lg:pt-[31vh] lg:pl-[max(2vw,1rem)]">
            <p
              ref={summaryRef}
