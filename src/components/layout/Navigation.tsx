...
const navItems = [
  ...
  { labelKey: "services", href: "/servicii/drept-civil" },
            ...
            item.labelKey === "services" ? (
              <div key={item.labelKey} className="group relative">
                ...
                <div className="pointer-events-none absolute left-0 top-full pt-5 opacity-0 transition duration-300 group-hover:pointer-events-auto group-hover:opacity-100">
                  <div className="w-[420px] border border-cream/15 bg-navy/98 p-6">
                    <div className="eyebrow text-cream/70">Arii</div>
            ...
            {navItems.map((item) =>
              item.labelKey === "services" ? (
                <div key={item.labelKey}>
                  <button type="button" onClick={() => setServicesOpen((value) => !value)} className="nav-link flex w-full items-center justify-between">
                    {nav.services}
