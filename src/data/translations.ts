...
export const translations = {
  ro: {
    ...
    aboutPage: {
      ...
      title: "Aliona Pantelei lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore",
      bio:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.",
      expertiseTitle: "Expertiză",
      expertiseTags: [
        "Drept comercial",
        "Imigrare și rezidență",
        "Tranzacții imobiliare",
        "Contracte și negocieri",
        "Documente și traduceri",
        "Suport juridic externalizat",
      ],
      industriesTitle: "Industrii",
      industriesTags: [
        "Antreprenori",
        "Expați",
        "Investitori privați",
      ...
      representativeTitle: "Experience",
  ...
  ru: {
    ...
    aboutPage: {
      ...
      expertiseTags: [
        "Коммерческое право",
        "Иммиграция и резиденция",
        "Сделки с недвижимостью",
        "Договоры и переговоры",
        "Документы и переводы",
        "Юридический аутсорсинг",
      ],
      industriesTitle: "Сферы",
      industriesTags: [
        "Предприниматели",
        "Экспаты",
        "Частные инвесторы",
