...
export const translations = {
  ro: {
    ...
    aboutPage: {
      ...
      industriesTitle: "Clienți și domenii",
      industriesTags: [
        "Antreprenori",
        "Expați",
        "Investitori",
      ...
      representativeTitle: "Ce urmăresc în fiecare mandat",
      representativeEyebrow: "Reprezentare și coordonare",
      representativeItems: [
        "Clarificarea situației juridice înainte de pregătirea documentelor.",
        "Reducerea riscurilor prin verificarea actelor și a consecințelor practice.",
        "Comunicare directă și structurată cu instituțiile, partenerii și clienții.",
        "Coordonarea etapelor astfel încât dosarul să avanseze fără blocaje inutile.",
        "Atenție la detalii în redactare, depunere și urmărirea rezultatului.",
        "Responsabilitate deplină pentru fiecare proiect preluat.",
      ],
      representativeMore: "Mai multe detalii",
    ...
    briefPage: {
      eyebrow: "Brief",
      title: "Descrieți situația. Vom înțelege mai repede contextul și următorul pas.",
      description:
        "Completați punctele esențiale: ce trebuie rezolvat, care este termenul și ce documente există deja. Răspunsul va fi mai precis dacă informația este structurată.",
      form: {
        name: "Nume",
        email: "Email",
        phone: "Telefon",
        service: "Tipul solicitării",
        servicePlaceholder: "Alegeți o direcție",
        deadline: "Termen / urgență",
        message: "Descrierea situației",
        submit: "TRIMITE BRIEF-UL",
      },
      options: ["Afaceri", "Imigrare", "Imobiliare", "Documente", "Altă situație"],
      notes: [
        "Descrieți obiectivul în 3–5 fraze.",
        "Menționați termenul relevant, dacă există.",
        "Indicați ce documente sunt deja pregătite.",
      ],
      success: "Brief-ul a fost pregătit în email. Verificați mesajul și trimiteți-l.",
    },
    blogPage: {
  ...
  ru: {
    ...
    aboutPage: {
      ...
      bio:
        "Меня зовут Алёна Пантелей — юрист и основатель PANTELEI LEGAL CONSULTING. Я помогаю предпринимателям и частным клиентам решать юридические вопросы в Румынии: от регистрации бизнеса до получения гражданства и сопровождения сделок. Моя задача — не просто оформить документы, а защитить ваши интересы и избежать рисков. Каждый проект ведётся с вниманием к деталям и полной ответственностью за результат.",
      expertiseTitle: "Сферы экспертизы",
      expertiseTags: [
        "Коммерческое право",
        "Иммиграция",
        "Гражданство",
      ...
      industriesTitle: "Клиенты и направления",
      industriesTags: [
        "Предприниматели",
        "Экспаты",
        "Инвесторы",
      ...
      representativeTitle: "На что направлена работа",
      representativeEyebrow: "Представительство и координация",
      representativeItems: [
        "Прояснение юридической ситуации до подготовки документов.",
        "Снижение рисков через проверку документов и практических последствий.",
        "Прямая и структурированная коммуникация с учреждениями, партнёрами и клиентами.",
        "Координация этапов так, чтобы дело двигалось без лишних задержек.",
        "Внимание к деталям при подготовке, подаче и сопровождении результата.",
        "Полная ответственность за каждый принятый проект.",
      ],
      representativeMore: "Подробнее",
    ...
    briefPage: {
      eyebrow: "Бриф",
      title: "Опишите ситуацию. Так будет проще быстро понять контекст и следующий шаг.",
      description:
        "Заполните основные пункты: что нужно решить, какие сроки важны и какие документы уже есть. Чем структурнее вводные, тем точнее будет первичный ответ.",
      form: {
        name: "Имя",
        email: "Email",
        phone: "Телефон",
      ...
      options: ["Бизнес", "Иммиграция", "Недвижимость", "Документы", "Другая ситуация"],
      notes: [
        "Опишите цель в 3–5 предложениях.",
        "Укажите важный срок, если он есть.",
        "Напишите, какие документы уже подготовлены.",
      ],
      success: "Бриф подготовлен в email. Проверьте письмо и отправьте его.",
    },
    blogPage: {
